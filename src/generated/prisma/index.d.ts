...
export namespace Prisma {
  ...
  */
	...
	export type UserModelOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
		$Extensions.GetOmit<'id' | 'email' | 'password' | 'name', ExtArgs['result']['userModel']>;
	...
	type UserModelGetPayload<S extends boolean | null | undefined | UserModelDefaultArgs> =
		$Result.GetResult<Prisma.$UserModelPayload, S>;
	...
	> {
		...
		findMany<T extends UserModelFindManyArgs>(
			...
			$Result.GetResult<Prisma.$UserModelPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions>
		>;
		...
		create<T extends UserModelCreateArgs>(
			...
			$Result.GetResult<Prisma.$UserModelPayload<ExtArgs>, T, 'create', GlobalOmitOptions>,
			never,
			ExtArgs,
			GlobalOmitOptions
		>;
		...
		createManyAndReturn<T extends UserModelCreateManyAndReturnArgs>(
			args?: SelectSubset<T, UserModelCreateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$UserModelPayload<ExtArgs>,
				T,
		...
		delete<T extends UserModelDeleteArgs>(
			...
			$Result.GetResult<Prisma.$UserModelPayload<ExtArgs>, T, 'delete', GlobalOmitOptions>,
			never,
			ExtArgs,
			GlobalOmitOptions
		>;
		...
		update<T extends UserModelUpdateArgs>(
			...
			$Result.GetResult<Prisma.$UserModelPayload<ExtArgs>, T, 'update', GlobalOmitOptions>,
			never,
			ExtArgs,
			GlobalOmitOptions
		>;
		...
		updateManyAndReturn<T extends UserModelUpdateManyAndReturnArgs>(
			args: SelectSubset<T, UserModelUpdateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$UserModelPayload<ExtArgs>,
				T,
		...
		upsert<T extends UserModelUpsertArgs>(
			...
			$Result.GetResult<Prisma.$UserModelPayload<ExtArgs>, T, 'upsert', GlobalOmitOptions>,
			never,
			ExtArgs,
			GlobalOmitOptions
		>;
		...
		aggregate<T extends UserModelAggregateArgs>(
			args: Subset<T, UserModelAggregateArgs>,
		...
		>(
			args: SubsetIntersection<T, UserModelGroupByArgs, OrderByArg> & InputErrors,
		): {} extends InputErrors
			? GetUserModelGroupByPayload<T>
